 ...
 */
static __inline void __list_add(struct list_head *new2,
 ...
 */
static __inline void list_add(struct list_head *new2, struct list_head *head)
{
 ...
 */
static __inline void list_add_tail(struct list_head *new2, struct list_head *head)
{
...
#define list_for_each_entry_continue(pos, head, member)			\
	for (pos = list_entry(pos->member.next, typeid(*pos), member),	\
